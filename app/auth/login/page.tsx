...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen px-6 py-8">
      ...
      <h1 className="font-serif text-3xl text-wf-ivory mb-2">Welcome Back</h1>
      ...
      <div className="mt-8">
        ...
        <div className="flex justify-center gap-4 mt-4">
          <button onClick={handleGoogleLogin} className="w-12 h-12 bg-wf-gray-light rounded-full flex items-center justify-center hover:bg-wf-gray transition-colors">
      ...
      <p className="mt-8 text-center text-gray-500 text-sm">
        ...
        <Link href="/auth/signup" className="text-wf-gold hover:text-wf-gold-light">
          Sign up
        </Link>
      </p>
    </div>
